...
يقومُ جُزءُ التّرميز بمُعالجة التسلسُل المُدخل، أي القيام بعمليّات حِسابيّة مُعيَّنة عليه، لاستخراج مُوجِّهٍ ذي طُول ثابت يحتوى على خُلاصةِ مُحتوى ومعنى سلسلة المعلومات المُدخلة، مثلا الجُملة المُدخلة. يُسمَّى هذا المُوجِّه المُستخرَج بمُوجِّه السِّياق. 
