...
عند بسط كيفية مُعالجة الشبكة العصبية التكراريّة لمُدخلاتها سنجد أنّها في الوقت t تُعالج كُل عنصر من التسلسل المُدخل إعتمادً على المُدخل الحالي $$x_t $$ وأيضا على مُخرج خليّة الRNN في الوقت السابق t-1.

<img class="img-fluid" src="/assets/images/RNN_overview.png" alt="نظرة عامّة في الRNN">

في الرسم التوضيحي أعلاه، تجد بسطًا للمُعالجة التكرارية الحاصلة في خليّة RNN حيثُ تُظهر الروابط باللون الأحمر الحاجة إلى القيام بالحسابات على كُّل عناصر تسلسل البيانات السابقة حتى نتمكن من حساب العنصر في الوقت الحالي t، ممّا يعني أنه من غير الممكن حساب كُلّ عناصر المُخرجات $$y_t$$ بالتوازي، وهو ما يحدُّ من سرعة التعلّم، فيؤدّي إلى بُطئ عمليّة تدريب نماذج الشبكة العصبية التكرارية ككُل. ** لذا فالمُشكل الأساسي الذي وجب على حلُّه هو إيجاد طريقة للتعلّم من سلاسل البيانات 
بشكل مُتوازي، وليس تسلسُلي أو تكراري.** 
