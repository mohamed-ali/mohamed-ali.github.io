...
يُضاف مُدخل الطبقة الفرعية إلى مُخرجها وذلك ما يُسمّى بتقنية "وصلات البواقي"[3] والتي تُسهّل عمليّة التحسين لإيجاد أفضل قيم لمُعاملات النموذج.
ثم تُطبَّق عمليّة "التسوية"[4] على نتيجة جمع المُدخل مع المُخرج.    
...
3. [وصلات البواقي](https://paperswithcode.com/method/residual-connection)
