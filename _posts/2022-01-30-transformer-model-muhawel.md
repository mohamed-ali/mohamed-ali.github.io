...
في الرسم أعلاه، تجد بسطًا للمُعالجة التكرارية الحاصلة في خليّة RNN حيثُ تُظهر الروابط باللون الأحمر الحاجة إلى القيام بالحسابات على كُّل عناصر تسلسل البيانات السابقة حتى نتمكن من حساب العناصر في هذا الوقت t، ممّا يعني أنه من غير الممكن حساب كُلّ عناصر المُخرجات $$y_t$$ بالتوازي، ممّا يحدُّ من سرعة التعلّم. وهذا ما يجعل تدريب نماذج الشبكة العصبية التكرارية بطيئًا للغاية.
