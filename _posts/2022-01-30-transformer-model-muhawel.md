...
<br>
 ...
 قدمت الورقة البحثية "التعلُّم من التسلسُل إلى التسلسُل باستعمال الشبكات العصبية"ّ لهذا التصميم حيث أظهرت نتائج جيدة على مهمة الترجمة، ممّا أدّى إلي إنتشار استعمال هذه التقنية.
