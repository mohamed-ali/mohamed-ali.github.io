...
وقُدِّم هذا التصميم في الورقة البحثيّة "التعلُّم من التسلسُل إلى التسلسُل باستعمال الشبكات العصبية"[2] حيثُ أدَّى إلى تحسينِ أداء التعلُّم الآلي بشكل ملحوظ على مهمَّة الترجمة الآلية من الإنجليزيّة إلى الفرنسيّة، ممّا أدّى إلي انتشار استعماله في مجتمع البحث العلمي.
...
* لتبسيط سُبُل الفهم للقارئ، تمّ تحيينُ هذا المقال ليعتمد ترجمةَ المصطلحات التقنية كما وردت في [معجم البيانات والذّكاء الاصطناعي](https://sdaia.gov.sa/files/Data_and_AI_Glossary.pdf) الصادر عن الهيئة السعودية     للبيانات و الذّكاء الاصطناعي المعروفة بسدايا.
