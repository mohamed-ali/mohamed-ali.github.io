...
يعتمدُ جُزءُ فَكِّ الترميز على عِدَّةِ مُدخلات، سنستكلشفُها لاحقا، لإنشاء التسلسُل المُخرج كلمةً كلمةً، أي شيئًا فشيئا بشكل مُتتابع وليس في آنٍ واحد. أحدُ هذه المُدخلات هو مُوجِّه السِّياق الذي استخرجه جُزء الترميز سابقًا من التسلسُل المدُخل.
