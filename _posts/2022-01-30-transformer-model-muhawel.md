...
يعتمدُ جُزءُ فَكِّ الترميز على عِدَّةِ مُدخلات، سنستكشِفُها لاحقا، لإنشاء التسلسُل المُخرج كلمةً كلمةً، أي شيئًا فشيئًا بشكل مُتتابع وليس جُملةً في آنٍ واحد.
أحدُ هذه المُدخلات هو مُوجِّه السِّياق الذي اِستخرجه جُزء الترميز سابقًا من التسلسُل المدُخل.

تذكَّر بأَنَّ المُحوِّل هُوَ شَكلٌ من أشكالِ معماريَّاتِ الترميز وفكِّ-الترميز وليس الشكل الوحيد الذي يعتمدُها.
حيثُ يتميّز على غيره من جهة التصميم باعتماده بكثرة على آلية الإنتباه، كما سنرى لاحقًّا. بينما يتميَّزُ من جِهة التطبيق ويشيعُ استعمالُه نظرًا للنتائج الإجابية التي حققها في العديد من مهّمَات "فهم ومُعالجة اللّغات الطبيعية".

في التَّالي، سنتعمَّقُ شيئًا فشيئًا في تفاصيل مِعماريّة المُحوِّل، ليتحقَّقَ لَديك فهمٌ عميقٌ كافٍ يُمكِّنُك من توظيفها بكفاءة في عملك، و الاستلهام من طريقة تصميمها ومن التمشِّي الذِّي قاد إلي التَّصميم الحالي في بحثِكَ العِلمي. 
وسنبدأ رحلة التعلُّم هذه بتفصيل هيكلة جُزءَي الترميز وفكِّ الترميز المُكوِّنَين لهذه المعماريّة. 
...
وفي هذه المُعادلة، يُرمز للانتباه باسمه الانجليزي Attention. وهو يقبل ثلاث مُدخلات وهي عبارة عن ثلاثة مصفوفات. الأولى Q، وهو الحرف الأوّل من الكلمة Query أي الاستعلام، الثانية K وهو الحرف الأوّل من كلمة Key أي المفتاح، والمصفوفة الثّالثة V من كلمة Value أي القِيَم. سنكتشف لاحقًا مأتى هذه المُسمّيات ومعانيها.
