...
يتكامَلُ جُزءا مِعمارية المُحوّل لمُعالجة التسلسُل المدخل بهدف إنشاء التسلسُل المُخرج كما هو مُبيّن في الرسم التوضيحي التّالي.

<img class="img-fluid" src="/assets/images/tramsformer-overview-ar.png" alt="نظرة عامة في هيكلة خوارزمية المُحوِّل">

يقومُ جُزءُ التّرميز بمُعالجة التسلسُل المُدخل، أي القيام بعمليّات حِسابيّة مُعيَّنة عليه، لاستخراج مُوجِّهٍ ذي طُولٍ ثابت يحتوى على خُلاصةِ مُحتوى ومعنى سِلسلة المعلومات المُدخلة، مثلا الجُملة المُدخلة. يُسمَّى هذا المُوجِّه المُستخرَج بمُوجِّه السِّياق. 

يعتمدُ جُزءُ فَكِّ الترميز على عِدَّةِ مُدخلات، سنستكشِفُها لاحقا، لإنشاء التسلسُل المُخرج كلمةً كلمةً، أي شيئًا فشيئًا بشكل مُتتابع وليس جُملةً في آنٍ واحد. أحدُ هذه المُدخلات هو مُوجِّه السِّياق الذي استخرجه جُزء الترميز سابقًا من التسلسُل المدُخل.
