...
A typical e-commerce website, or any website for that matter, has a search bar that enables user to find what they are looking for. In the case of e-commerce however, the importance of this search box is more critical. 

Good search user experience and search results relevancy can make the difference between converting a visitor or sending the potential customer to the competition.
